    ...
    return (
        <><div>
            ...
            <section className="bg-lime-100 dark:bg-gray-900">
                ...
                <h2 className="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nosso Time</h2>
            ...
            <section className="bg-lime-100 dark:bg-gray-900">
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        ...
                        <p className="font-light text-gray-800 lg:mb-16 sm:text-xl dark:text-gray-400">Projeto desenvolvido com muito carinho e dedicação pelo nosso time</p>
                    </div>
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-800">
                            ...
                            <div className="p-5">
                                ...
                                <span className="text-gray-800 dark:text-gray-400">PIO ou Ex técnico Informática</span>
                                <p className="mt-3 mb-4 font-light text-gray-800 dark:text-gray-400">A sua vida e o seu mundo mudam quando você muda</p>
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-800">
                            ...
                            <div className="p-5">
                                ...
                                <span className="text-gray-800 dark:text-gray-400">PIO ou ex Analista de suporte</span>
                                <p className="mt-3 mb-4 font-light text-gray-800 dark:text-gray-400">A sua vida e o seu mundo mudam quando você muda</p>
                                <ul className="display: inline-flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" className="text-gray-800 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-800">
                            ...
                            <div className="p-5">
                                ...
                                <span className="text-gray-800 dark:text-gray-400">Senior Front-end Developer</span>
